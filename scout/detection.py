...
SCOUT's nuclei detection is based on a curvature-based seeded watershed algorithm which was previously published:
(https://www.mdpi.com/2313-433X/2/4/31)

This module contains a GPU-accelerated implementation of this algorithm using the CUDA capabilities of Pytorch.
The module will fall back to CPU if no CUDA-enabled device is found or if the CPU version of Pytorch is installed.
"""
